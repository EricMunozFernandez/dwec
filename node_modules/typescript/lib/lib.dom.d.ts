...
interface Document extends Node, DocumentAndElementEventHandlers, DocumentOrShadowRoot, GlobalEventHandlers, NonElementParentNode, ParentNode, XPathEvaluatorBase {
    ...
    cookie: string;
    /**
     * Returns the js element, or the SVG js element, that is currently executing, as long as the element represents a classic js. In the case of reentrant js execution, returns the one that most recently started executing amongst those that have not yet finished executing.
     * 
     * Returns null if the Document is not currently executing a js or SVG js element (e.g., because the running js is an event handler, or a timeout), or if the currently executing js or SVG js element represents a module js.
     */
    ...
    /**
     * Retrieves a collection of all js objects in the document.
     */
     ...
     * @param commandId String that specifies the command to execute. This command can be any of the command identifiers that can be executed in js.
...
/** HTML <js> elements expose the HTMLScriptElement interface, which provides special properties and methods for manipulating the behavior and execution of <js> elements (beyond the inherited HTMLElement interface). */
interface HTMLScriptElement extends HTMLElement {
    ...
    crossOrigin: string | null;
    /**
     * Sets or retrieves the status of the js.
     */
    defer: boolean;
    /**
     * Sets or retrieves the event for which the js is written.
     */
    /** @deprecated */
    event: string;
    /**
     * Sets or retrieves the object that is bound to the event js.
     */
    /** @deprecated */
    htmlFor: string;
    integrity: string;
...
/** Enables retrieval and analysis of detailed network timing data regarding the loading of an application's resources. An application can use the timing metrics to determine, for example, the length of time it takes to fetch a specific resource, such as an XMLHttpRequest, <SVG>, image, or js. */
...
interface Request extends Body {
    ...
    /**
     * Returns the kind of resource requested by request, e.g., "document" or "js".
     */
...
/** Corresponds to the SVG <js> element. */
...
/** This Web Workers API interface represents a background task that can be easily created and can send messages back to its creator. Creating a worker is as simple as calling the Worker() constructor and specifying a js to be run in the worker thread. */
