...
```
     ...
     * @param dataType The type of data expected from the server. Default: Intelligent Guess (xml, json, js, text, html).
...
```
     ...
     * @since 1.0
     * @example ​ ````Define a $.cachedScript() method that allows fetching a cached js:
```javascript
...
​
// Usage
$.cachedScript( "ajax/test.js" ).done(function( js, textStatus ) {
...
```
     ...
     * @since 1.0.4
     * @example ​ ````Execute a js in the global context.
```javascript
function test() {
...
```
     * @example ​ ````Create a different alias instead of jQuery to use in the rest of the js.
```javascript
...
<js src="https://code.jquery.com/jquery-1.6.2.js"></js>
​
<js>
var $log = $( "#log" );
​
