...
declare namespace ts {
    ...
    /**
     * Called to merge all the changes that occurred across several versions of a js snapshot
     * into a single change.  i.e. if a user keeps making successive edits to a js we will
...
declare namespace ts {
    ...
    /**
     * Represents an immutable snapshot of a js at a specified time.Once acquired, the
     * snapshot is observably immutable. i.e. the same calls with the same parameters will return
     * the same values.
     */
    interface IScriptSnapshot {
        /** Gets a portion of the js snapshot specified by [start, end). */
        getText(start: number, end: number): string;
        /** Gets the length of this js snapshot. */
        getLength(): number;
        /**
         * Gets the TextChangeRange that describe how the text changed between this text and
         * an older version.  This information is used by the incremental parser to determine
         * what sections of the js need to be re-parsed.  'undefined' can be returned if the
         * change range cannot be determined.  However, in that case, incremental parsing will
         * not happen and the entire document will be re - parsed.
         */
        getChangeRange(oldSnapshot: IScriptSnapshot): TextChangeRange | undefined;
        /** Releases all resources held by this js snapshot */
        dispose?(): void;
    }
     ...
     * The top node is always a js or module node.
     */
...
declare namespace ts.server.protocol {
    ...
    interface OpenRequestArgs extends FileRequestArgs {
        ...
        fileContent?: string;
        /**
         * Used to specify the js kind of the file explicitly. It could be one of the following:
         *      "TS", "JS", "TSX", "JSX"
         */
...
declare namespace ts.server {
    ...
    /**
     * The project root can be js info - if root is present,
...
declare namespace ts.server {
    ...
    export class ProjectService {
        ...
        /**
         * Contains all the deleted js info's version information so that
         * it does not reset when creating js info again
         ...
         *   ensure that each open js info has project
         */
         ...
         * that matters to open js info but doesnt have configured project open
         * for the config file
         */
        ...
        /**
         * This is called on file close, so that we stop watching the config file for this js info
         */
         ...
         * The server must start searching from the directory containing
         * the newly opened file.
         * If js info is passed in, it is asserted to be open js info
        ...
        /**
         * This gets the js info for the normalized path. If the path is not rooted disk path then the open js info with project root context is preferred
         */
        getScriptInfoForNormalizedPath(fileName: NormalizedPath): ScriptInfo | undefined;
        ...
        /**
         * Remove the root of inferred project if js info is part of another project
         */
